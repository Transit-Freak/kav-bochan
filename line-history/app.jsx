...
function events2012(snap) {
  ...
  for (const c in snap) {
    ...
    out.push({ c, d: "2012-06-26", k: "gtfs2012", n, t: addr, la, lo, tmp99 });
    if (tmp99) continue;
    ...
    <div className="card">
      ...
      {mon === "2012" && (
        <p className="pdesc">🕰️ רישום התחנות של 2012: 32,987 תחנות מקובץ ה-GTFS של משרד התחבורה מ-2012, כפי שיובאו ל-<a href="https://www.openstreetmap.org/changeset/14265835" target="_blank" rel="noopener">OpenStreetMap</a> (רישיון ODbL).
          לכל תחנה: השם, הכתובת והמיקום של אז, ואחריהם מה השתנה באותו מק״ט עד תחילת התיעוד שלנו במרץ 2017 — שינוי שם, הזזה (30 מ׳ ומעלה), או ביטול. מק״ט שנמצא מ-2017 במרחק קילומטר ומעלה נחשב מק״ט שהוקצה מחדש לתחנה אחרת, לא הזזה. מק״ט של 7 ספרות שמתחיל ב-99 (2,600 תחנות) הוא מספר זמני שמשרד התחבורה נתן בקובץ 2012 לתחנות בלי מספר שלט; הן לא ״בוטלו״, אלא רשומות היום תחת מק״ט אחר.
