...
function renderDocumentReview(t){
 const r=documentReviews[t.id];if(!r)return t.classification==='operating_tender'?`<details class="fielddetails"><summary>קווים ומסלולים · הרשימה עדיין חסרה</summary><ul>${routeGaps(t.id)||'<li>רשימת הקווים והמפות עדיין לא נבדקו מול נספחי המכרז.</li>'}</ul></details>`:'';
