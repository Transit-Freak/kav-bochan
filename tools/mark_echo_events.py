...
זה עדיין שינוי אמיתי בחלופה הזאת (שלמה: "אל תשנה, תוסיף בהודעה שהשינוי קרה בחלופה…"): האתר וההתראות
מציגים אותו, ומוסיפים "השינוי כבר נכנס ב-19.07 בחלופה 10350-1-4 של הקו; עכשיו גם בחלופה הזאת".
