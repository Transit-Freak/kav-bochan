...
def test_brief_is_the_key_sentence_in_plain_words():
    ...
    assert tender_sections.simplify('הזוכה בהליך התחרותי יגיש למפקח על התעבורה, לכל המאוחר 180 ימים ממועד ההודעה על הזכייה, מסמכים.') == 'החברה שתזכה תגיש למפקח על התעבורה, לכל המאוחר 180 ימים מהיום שהודיעו למי שזכה, מסמכים.'
